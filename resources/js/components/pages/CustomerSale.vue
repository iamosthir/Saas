      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title text-center">
            <strong>أنشاء فاتورة بيع <i class="fas fa-file-invoice-dollar"></i></strong>
          </h5>
          <form class="mt-5" method="POST" @submit.prevent="createCustomerInvoice">
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-12 mb-4 text-center">
                <Button :form="form" class="btn btn-success">
                  أنشاء الفاتورة <i class="fas fa-check-circle"></i>
                </Button>
              </div>
            </div>
          </form>
...
export default {
  ...
  methods: {
    ...
    createCustomerInvoice() {
      ...
      // Set customer_id from route
      this.form.customer_id = this.customer_id;
      // Add all products info, including names
