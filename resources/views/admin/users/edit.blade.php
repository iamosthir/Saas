...
<div class="card mb-4">
    <div class="card-body">
        <h6 class="text-muted mb-1">تعديل مستخدم في:</h6>
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('admin.users.update', [$merchant, $user]) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select @error('role') is-invalid @enderror" name="role" required>
                        ...
                        <option value="super" {{ old('role', $user->role) === 'super' ? 'selected' : '' }}>مدير</option>
                    </select>
                    @error('role')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
