...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              clearTimeout(_this3.searchTimeout);
              if (!(!_this3.searchQuery || _this3.searchQuery.length < 1)) {
                _context3.next = 4;
                break;
              }
              _this3.products = [];
            ...
            case 4:
              _this3.searchTimeout = setTimeout( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
                var barcodeRes, result, response, _error$response, _response;
                return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                  while (1) switch (_context2.prev = _context2.next) {
                    case 0:
                      _this3.loading = true;
                      _context2.prev = 1;
                      if (!(_this3.searchQuery.length >= 4)) {
                        _context2.next = 11;
                        break;
                      }
                      _context2.next = 5;
                      return axios__WEBPACK_IMPORTED_MODULE_0___default().get("/dashboard/api/pos/products/barcode/".concat(_this3.searchQuery));
                    case 5:
                      barcodeRes = _context2.sent;
                      if (!barcodeRes.data.success) {
                        _context2.next = 11;
                        break;
                      }
                      result = barcodeRes.data.data;
                      _this3.addToCart(result.product, result.variation);
                      _this3.clearSearch();
                      return _context2.abrupt("return");
                    case 11:
                      _context2.next = 13;
                      return axios__WEBPACK_IMPORTED_MODULE_0___default().get('/dashboard/api/pos/products/search', {
                        params: {
                          q: _this3.searchQuery
                        }
                      });
                    case 13:
                    ...
                    case 23:
                      ...
                      _this3.products = _response.data.data || [];
                      _context2.next = 30;
                      break;
                    case 27:
                      _context2.prev = 27;
                      _context2.t1 = _context2["catch"](20);
                      console.error('Search error:', _context2.t1);
                    case 30:
                      _context2.prev = 30;
                ...
                }, _callee2, null, [[1, 17, 30, 33], [20, 27]]);
              })), 300);
            case 5:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              existingIndex = _this4.currentCart.items.findIndex(function (i) {
                return i.product_id === item.product_id && i.product_variation_id === item.product_variation_id;
              });
              if (existingIndex >= 0) {
                _this4.currentCart.items[existingIndex].quantity++;
                _this4.updateItemTotal(existingIndex);
              } else {
                item.line_total = item.unit_price * item.quantity;
                _this4.currentCart.items.push(item);
              }
              _this4.recalculateCart();
              _this4.clearSearch();

              // Sync with backend if cart has ID
              if (!_this4.currentCart.id) {
                _context4.next = 8;
                break;
              }
              _context4.next = 8;
              return _this4.syncCartToBackend();
            case 8:
            case "end":
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              if (!(!_this5.customerSearch || _this5.customerSearch.length < 2)) {
                _context5.next = 3;
                break;
              }
              _this5.customers = [];
            ...
            case 10:
              ...
              console.error('Customer search error:', _context5.t0);
            case 13:
            case "end":
    ...
    createCustomer: function createCustomer() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
        var _this6$$toast, response, _this6$$toast2;
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              if (!(!_this6.newCustomer.customer_name || !_this6.newCustomer.phone1)) {
                _context6.next = 3;
                break;
              }
              (_this6$$toast = _this6.$toast) === null || _this6$$toast === void 0 ? void 0 : _this6$$toast.error('Name and phone are required');
              return _context6.abrupt("return");
            case 3:
              _context6.prev = 3;
              _context6.next = 6;
              return axios__WEBPACK_IMPORTED_MODULE_0___default().post('/dashboard/api/pos/customers', _this6.newCustomer);
            case 6:
              response = _context6.sent;
              _this6.selectCustomer(response.data.data);
              _this6.newCustomer = {
                customer_name: '',
                phone1: ''
              };
            ...
            case 11:
              ...
              (_this6$$toast2 = _this6.$toast) === null || _this6$$toast2 === void 0 ? void 0 : _this6$$toast2.error('Failed to create customer');
            case 14:
            case "end":
    ...
    openPayment: function openPayment() {
      ...
      this.$nextTick(function () {
        var _this7$$refs$paymentI;
        (_this7$$refs$paymentI = _this7.$refs.paymentInput) === null || _this7$$refs$paymentI === void 0 ? void 0 : _this7$$refs$paymentI.focus();
      });
    },
    ...
    completeSale: function completeSale() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
        var saleId, _this8$currentCart$cu, createRes, response, _this8$$toast, _error$response2, _error$response2$data;
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              if (_this8.canCompleteSale) {
                _context7.next = 2;
                break;
              }
            ...
            case 2:
              ...
              return axios__WEBPACK_IMPORTED_MODULE_0___default().post('/dashboard/api/pos/sales', {
                customer_id: (_this8$currentCart$cu = _this8.currentCart.customer) === null || _this8$currentCart$cu === void 0 ? void 0 : _this8$currentCart$cu.id,
                items: _this8.currentCart.items
              });
            case 7:
              createRes = _context7.sent;
              saleId = createRes.data.data.id;
            case 9:
              if (!_this8.currentCart.discount_type) {
                _context7.next = 12;
                break;
              }
              _context7.next = 12;
              return axios__WEBPACK_IMPORTED_MODULE_0___default().put("/dashboard/api/pos/sales/".concat(saleId), {
                discount_type: _this8.currentCart.discount_type,
                discount_amount: _this8.currentCart.discount_amount
              });
            case 12:
              _context7.next = 14;
              return axios__WEBPACK_IMPORTED_MODULE_0___default().post("/dashboard/api/pos/sales/".concat(saleId, "/complete"), {
                payments: _this8.payments
              });
            case 14:
              response = _context7.sent;
              _this8.completedSale = response.data.data;
              _this8.showPaymentModal = false;
              _this8.showReceiptModal = true;

              // Print if auto-print enabled
              if (_this8.settings.print_receipt_auto) {
                _this8.printReceipt();
              }
              _context7.next = 25;
              break;
            case 21:
              ...
              console.error('Failed to complete sale:', _context7.t0);
              (_this8$$toast = _this8.$toast) === null || _this8$$toast === void 0 ? void 0 : _this8$$toast.error(((_error$response2 = _context7.t0.response) === null || _error$response2 === void 0 ? void 0 : (_error$response2$data = _error$response2.data) === null || _error$response2$data === void 0 ? void 0 : _error$response2$data.message) || 'Failed to complete sale');
            case 25:
            case "end":
    ...
    parkSale: function parkSale() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
        var _this9$$toast, saleId, _this9$currentCart$cu, createRes, _this9$$toast2;
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            case 0:
              if (!(_this9.currentCart.items.length === 0)) {
                _context8.next = 2;
                break;
              }
            ...
            case 9:
              ...
              return axios__WEBPACK_IMPORTED_MODULE_0___default().post("/dashboard/api/pos/sales/".concat(saleId, "/park"), {
                park_name: "Cart ".concat(_this9.currentCartIndex + 1)
              });
            case 11:
              _context8.next = 13;
              return _this9.loadParkedSales();
            case 13:
              // Reset current cart
              _this9.carts[_this9.currentCartIndex] = _this9.createEmptyCart();
              (_this9$$toast = _this9.$toast) === null || _this9$$toast === void 0 ? void 0 : _this9$$toast.success('Sale parked');
              _context8.next = 21;
              break;
            case 17:
              _context8.prev = 17;
              _context8.t0 = _context8["catch"](2);
              console.error('Failed to park sale:', _context8.t0);
              (_this9$$toast2 = _this9.$toast) === null || _this9$$toast2 === void 0 ? void 0 : _this9$$toast2.error('Failed to park sale');
            case 21:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            ...
            case 3:
              ...
              _this10.parkedSales = response.data.data || [];
              _context9.next = 10;
              break;
            case 7:
              _context9.prev = 7;
              _context9.t0 = _context9["catch"](0);
              console.error('Failed to load parked sales:', _context9.t0);
            case 10:
            case "end":
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10() {
        ...
        return _regeneratorRuntime().wrap(function _callee10$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
            ...
            case 3:
              // Load into cart
              _this11.carts[_this11.currentCartIndex] = _this11.saleToCart(sale);

              // Remove from parked list
              _context10.next = 6;
              return _this11.loadParkedSales();
            case 6:
              _this11.showParkedModal = false;
              _context10.next = 13;
              break;
            case 9:
              _context10.prev = 9;
              _context10.t0 = _context10["catch"](0);
              console.error('Failed to resume sale:', _context10.t0);
              (_this11$$toast = _this11.$toast) === null || _this11$$toast === void 0 ? void 0 : _this11$$toast.error('Failed to resume sale');
            case 13:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee11$(_context11) {
          while (1) switch (_context11.prev = _context11.next) {
            ...
            case 9:
              ...
              console.error('Failed to delete parked sale:', _context11.t0);
            case 12:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee12$(_context12) {
          while (1) switch (_context12.prev = _context12.next) {
            ...
            case 2:
              _context12.prev = 2;
              _context12.next = 5;
              return axios__WEBPACK_IMPORTED_MODULE_0___default().get("/dashboard/api/pos/print/".concat(_this13.completedSale.id, "/html"), {
                responseType: 'text'
              });
            case 5:
            ...
            case 12:
              ...
              console.error('Failed to print receipt:', _context12.t0);
            case 15:
            case "end":
  ...
  mounted: function mounted() {
    ...
    window.addEventListener('online', function () {
      _this14.isOnline = true;
    });
    window.addEventListener('offline', function () {
      _this14.isOnline = false;
    });
...
var render = function render() {
  ...
  return _c("div", {
  ...
  }), _vm._v(" Offline Mode - Sales will sync when online\n    ")]) : _vm._e(), _vm._v(" "), _c("div", {
    ...
    }, [_c("span", [_vm._v("Cart " + _vm._s(index + 1))]), _vm._v(" "), cart.items.length ? _c("span", {
    ...
    staticClass: "fas fa-search"
  }), _vm._v(" "), _c("p", [_vm._v("No products found")])]) : _vm.products.length === 0 ? _c("div", {
    staticClass: "empty-state"
  }, [_c("i", {
    staticClass: "fas fa-box-open"
  }), _vm._v(" "), _c("p", [_vm._v("Search for products or scan barcode")])]) : _vm._l(_vm.products, function (product) {
    return _c("div", {
      key: product.id,
      ...
      "class": {
        "low-stock": product.total_stock <= product.low_stock_threshold
      }
    }, [_vm._v("\n                            Stock: " + _vm._s(product.total_stock) + "\n                        ")])])]);
  })], 2)]), _vm._v(" "), _c("div", {
  ...
  }), _vm._v(" Select Customer (F9)\n                ")])]), _vm._v(" "), _c("div", {
    staticClass: "cart-items"
  }, [_vm.currentCart.items.length === 0 ? _c("div", {
    staticClass: "empty-cart"
  }, [_c("i", {
    staticClass: "fas fa-shopping-cart"
  }), _vm._v(" "), _c("p", [_vm._v("Cart is empty")]), _vm._v(" "), _c("small", [_vm._v("Search for products to add")])]) : _vm._l(_vm.currentCart.items, function (item, index) {
    return _c("div", {
      key: item.id || index,
  ...
  }, [_c("span", [_vm._v("Subtotal")]), _vm._v(" "), _c("span", [_vm._v(_vm._s(_vm.formatCurrency(_vm.currentCart.subtotal)))])]), _vm._v(" "), _vm.currentCart.discount_value > 0 ? _c("div", {
    ...
    staticClass: "fas fa-percent"
  }), _vm._v(" Add Discount (F8)\n                    ")])]), _vm._v(" "), _vm.settings.tax_rate > 0 ? _c("div", {
    staticClass: "summary-row tax"
  }, [_c("span", [_vm._v("Tax (" + _vm._s(_vm.settings.tax_rate) + "%)")]), _vm._v(" "), _c("span", [_vm._v(_vm._s(_vm.formatCurrency(_vm.currentCart.tax_amount)))])]) : _vm._e(), _vm._v(" "), _c("div", {
    staticClass: "summary-row total"
  }, [_c("span", [_vm._v("Total")]), _vm._v(" "), _c("span", [_vm._v(_vm._s(_vm.formatCurrency(_vm.currentCart.total_amount)))])])]), _vm._v(" "), _c("div", {
  ...
  }, [_c("h5", [_vm._v("Select Variation")]), _vm._v(" "), _c("button", {
    ...
    }, [_vm._v("Stock: " + _vm._s(variation.quantity))])]);
    ...
    staticClass: "modal-header"
  }, [_c("h5", [_vm._v("Select or Create Customer")]), _vm._v(" "), _c("button", {
    staticClass: "close-btn",
    on: {
      click: function click($event) {
        _vm.showCustomerModal = false;
  ...
  }, [_vm._v("No customer found. Create new?")]), _vm._v(" "), _c("div", {
    ...
    staticClass: "modal-header"
  }, [_c("h5", [_vm._v(_vm._s(_vm.discountTarget === "sale" ? "Sale Discount" : "Item Discount"))]), _vm._v(" "), _c("button", {
    staticClass: "close-btn",
    on: {
      click: function click($event) {
        _vm.showDiscountModal = false;
    ...
    attrs: {
      type: "number",
      placeholder: _vm.discountForm.type === "percentage" ? "Enter %" : "Enter amount",
      min: "0"
    },
    domProps: {
      value: _vm.discountForm.amount
  ...
  }, [_vm._v("Apply")])])])])]) : _vm._e(), _vm._v(" "), _vm.showPaymentModal ? _c("div", {
    staticClass: "modal-overlay",
    on: {
      click: function click($event) {
        if ($event.target !== $event.currentTarget) return null;
    ...
    staticClass: "modal-header"
  }, [_c("h5", [_vm._v("Payment")]), _vm._v(" "), _c("button", {
    staticClass: "close-btn",
    on: {
      click: function click($event) {
        _vm.showPaymentModal = false;
  ...
  }, [_c("span", [_vm._v("Total Due")]), _vm._v(" "), _c("span", {
    staticClass: "amount"
  }, [_vm._v(_vm._s(_vm.formatCurrency(_vm.currentCart.total_amount)))])]), _vm._v(" "), _vm.payments.length > 0 ? _c("div", {
    staticClass: "paid-so-far"
  }, [_c("span", [_vm._v("Paid")]), _vm._v(" "), _c("span", [_vm._v(_vm._s(_vm.formatCurrency(_vm.totalPaid)))])]) : _vm._e(), _vm._v(" "), _vm.remainingAmount > 0 ? _c("div", {
    staticClass: "remaining"
  }, [_c("span", [_vm._v("Remaining")]), _vm._v(" "), _c("span", {
    staticClass: "amount"
  }, [_vm._v(_vm._s(_vm.formatCurrency(_vm.remainingAmount)))])]) : _vm._e(), _vm._v(" "), _vm.changeAmount > 0 ? _c("div", {
    staticClass: "change"
  }, [_c("span", [_vm._v("Change")]), _vm._v(" "), _c("span", {
  ...
  }, [_c("label", [_vm._v("Reference Number (optional)")]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
    ...
    attrs: {
      type: "text",
      placeholder: "Card auth code, transfer ref..."
    },
    domProps: {
      value: _vm.paymentReference
    },
  ...
  }, [_c("h6", [_vm._v("Payments")]), _vm._v(" "), _vm._l(_vm.payments, function (payment, index) {
    return _c("div", {
      key: index,
  ...
  }), _vm._v("\n                        " + _vm._s(_vm.isFullyPaid ? "Complete Sale (F12)" : "Complete with Split Payment") + "\n                    ")])])])])]) : _vm._e(), _vm._v(" "), _vm.showParkedModal ? _c("div", {
    staticClass: "modal-overlay",
    on: {
      click: function click($event) {
        if ($event.target !== $event.currentTarget) return null;
    ...
    staticClass: "modal-header"
  }, [_c("h5", [_vm._v("Parked Sales")]), _vm._v(" "), _c("button", {
    staticClass: "close-btn",
    on: {
      click: function click($event) {
        _vm.showParkedModal = false;
    ...
    staticClass: "fas fa-pause-circle"
  }), _vm._v(" "), _c("p", [_vm._v("No parked sales")])]) : _c("div", {
    ...
    }, [_vm._v(_vm._s(sale.items.length) + " items")]), _vm._v(" "), _c("div", {
    ...
    staticClass: "modal-header"
  }, [_c("h5", [_vm._v("Sale Complete")]), _vm._v(" "), _c("button", {
    staticClass: "close-btn",
    on: {
  ...
  }, [_c("p", [_vm._v("Sale #" + _vm._s((_vm$completedSale = _vm.completedSale) === null || _vm$completedSale === void 0 ? void 0 : _vm$completedSale.sale_number))]), _vm._v(" "), _c("p", {
    staticClass: "total"
    ...
    staticClass: "change"
  }, [_vm._v("\n                        Change: " + _vm._s(_vm.formatCurrency((_vm$completedSale4 = _vm.completedSale) === null || _vm$completedSale4 === void 0 ? void 0 : _vm$completedSale4.change_amount)) + "\n                    ")]) : _vm._e()]), _vm._v(" "), _c("div", {
